...
library('repgen')
query <- list(station='06899500', 
              dischargeIdentifier='Discharge.TS0058',
              stageIdentifier='Gage+height.TS0005',
              dailyDischargeIdentifier='Discharge.TS0058',
              waterYear='2012')

ts <- getJSON(query = query)
```
