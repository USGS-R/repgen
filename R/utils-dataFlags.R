...
#' @return A logical value that is \code{TRUE} if there is any data that is zero.
...
#' @return A logical value that is \code{TRUE} if there are any negative values.
...
#' 
#' @return Returns a logical value that is \code{TRUE} if the time series should
#'   be inverted.
...
#' @title isLogged
#' 
#' @description To check if a time series can be plotted on a logged axis.
#' 
#' @param isVolFlow A logical value indicating whether the time series measures 
#'   a volumetric flow or not.
#' @param ts_data The time series data itself. If this is \code{NULL} but the other
#'   params are \code{TRUE}, it returns \code{TRUE}.
#' @param excludeZeroNegative A logical value indicating whether the time series
#'   will exclude zero and negative values.
#' 
#' @return Returns \code{TRUE} if the time series can be plotted on a logged
#'   axis, and \code{FALSE} otherwise.
#'
