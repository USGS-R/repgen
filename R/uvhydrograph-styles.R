...
getUvStyle <- function(data, info, correctionLabels, plotName) {
  ...
  if (plotName == "primary") { 
    ...
    styles <- switch(names(data),
                ...
                appr_approved_uv = list(rect = list(xleft=data[[1]]$x0, xright=data[[1]]$x1, ybottom=data[[1]]$y0, ytop=data[[1]]$y1, col="lightskyblue", bg="lightskyblue", legend.name=legend.name, where='first')),
                appr_inreview_uv = list(rect = list(xleft=data[[1]]$x0, xright=data[[1]]$x1, ybottom=data[[1]]$y0, ytop=data[[1]]$y1, col="yellow2", legend.name=legend.name, where='first')),
                appr_working_uv = list(rect = list(xleft=data[[1]]$x0, xright=data[[1]]$x1, ybottom=data[[1]]$y0, ytop=data[[1]]$y1, col="lightpink", bg="lightpink", legend.name=legend.name, where='first')),
  ...
  if (plotName == "secondary"){
    ...
    styles <- switch(names(data),
                ...
                appr_approved = list(rect = list(xleft=data[[1]]$x0, xright=data[[1]]$x1, ybottom=data[[1]]$y0, ytop=data[[1]]$y1, col="lightskyblue", bg="lightskyblue", legend.name=legend.name, where='first')),
                appr_inreview = list(rect = list(xleft=data[[1]]$x0, xright=data[[1]]$x1, ybottom=data[[1]]$y0, ytop=data[[1]]$y1, col="yellow2", bg="yellow2", legend.name=legend.name, where='first')),
                appr_working = list(rect = list(xleft=data[[1]]$x0, xright=data[[1]]$x1, ybottom=data[[1]]$y0, ytop=data[[1]]$y1, col="lightpink", bg="lightpink", legend.name=legend.name, where='first'))
                ) 
  } 
