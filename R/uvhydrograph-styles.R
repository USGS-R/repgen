...
getUvStyles <- function() {
  styles=list(
      ...
      series_corr_ablines=list(untf=FALSE, col="blue", side=7, axes=FALSE),
      series_corr_arrows=list(side=7, axes=FALSE, col="blue", code=1, length = 0),
      series_corr_points=list(side=7, axes=FALSE, pch=22, col=rgb(0,0,255,180,maxColorValue=255), bg=rgb(255,255,255,125,maxColorValue=255)),
      series_corr_text=list(srt=0, cex=0.6, side=7, axes=FALSE, pos=1, offset = -0.12, col=rgb(0,0,255,240,maxColorValue=255)),
      ...
      series_corr2_correction_lbl="Data correction entry",
      series_corr2_lines=list(side=7, axes=FALSE),
      series_corr2_ablines=list(untf=FALSE, col="blue", side=7, axes=FALSE),
      series_corr2_arrows=list(side=7, axes=FALSE, col="blue", code=1, length = 0),
      series_corr2_points=list(pch=22, side=7, axes=FALSE, col=rgb(0,0,255,180,maxColorValue=255), bg=rgb(255,255,255,125,maxColorValue=255)),
      series_corr2_text=list(srt=0, cex=0.6, side=7, axes=FALSE, pos=1, offset = -0.12, col=rgb(0,0,255,240,maxColorValue=255)),
