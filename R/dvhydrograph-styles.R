getDvHydrographStyles <- function() {
  styles <- list(
    ...
    meas_q_points_true = list(pch = 21, bg = 'black', col = 'black', cex = .8, lwd=1, axes=FALSE, text.col="red"),
    meas_q_points_false = list(pch = 21, bg = 'black', col = 'black', cex = .8, lwd=1, axes=FALSE, text.col="blue"),
