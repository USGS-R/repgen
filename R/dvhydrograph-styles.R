getDvHydrographStyles <- function() {
  styles <- list(
    ...
    stat1e_lines = list(type="s", col="red1", lty=2, pch=20, cex=0.5),
    stat2e_lines = list(type="s", col="red2", lty=3, pch=20, cex=0.5),
    stat3e_lines = list(type="s", col="red3", lty=6, pch=20, cex=0.5),
