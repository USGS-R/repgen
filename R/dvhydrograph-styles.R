getDvHydrographStyles <- function() {
  styles <- list(
    ...
    est1EdgesEst = list(lty=1, col="blue", lwd=1, code=1, length=0),
    est1EdgesStat = list(lty=2, col="red1", lwd=1, code=1, length=0),
    est2EdgesEst = list(lty=1, col="maroon", lwd=1, code=1, length=0),
    est2EdgesStat = list(lty=3, col="red1", lwd=1, code=1, length=0),
    est3EdgesEst = list(lty=1, col="orange", lwd=1, code=1, length=0),
    est3EdgesStat = list(lty=6, col="red2", lwd=1, code=1, length=0),
    est4EdgesEst = list(lty=1, col="black", lwd=1, code=1, length=0),
    est4EdgesStat = list(lty=4, col="red3", lwd=1, code=1, length=0),
