...
**Time Series:** `r data[['reportMetadata']][['primaryTimeseriesIdentifier']]`

**Upchain Time Series:** `r data[['reportMetadata']][['upchainTimeseriesIdentifier']]`

**Rating Model:** `r data[['reportMetadata']][['ratingModelIdentifier']]`
</div>
