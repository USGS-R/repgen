...
---
<script>document.title="`r paste('V-Diagram - ', fetchReportMetadataField(data,'stationId'))`"</script>
<div class="header">
<div>
...
`r if(!isEmptyOrBlank(fetchRequestParametersField(data,'ratingModelIdentifier'))) {paste("**Rating Model:**",  fetchRequestParametersField(data,'ratingModelIdentifier'))}`
</div>
