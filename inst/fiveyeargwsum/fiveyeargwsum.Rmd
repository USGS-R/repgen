...
---
<script>document.title="`r paste('5-Year Groundwater - ', fetchReportMetadataField(data,'stationId'))`"</script>
<div class="header">
<div>
...
`r if(fetchReportMetadataField(data, 'excludeMinMax') || fetchReportMetadataField(data, 'excludeDiscrete')) {paste("**Advanced Options:**") }` 
