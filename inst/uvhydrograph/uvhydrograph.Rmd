...
---
<script>document.title="UV Hydro - " + `r fetchReportMetadataField(data,'stationId')`</script>
<div class="header">
<div>
...
<div class="header">
`r if(fetchReportMetadataField(data, 'excludeZeroNegative') || !isEmptyOrBlank(fetchReportMetadataField(data, 'excludeCorrections')) || fetchReportMetadataField(data, 'excludeDiscrete')) {paste("**Advanced Options:**") }` 
