...
`r if(!isEmptyOrBlank(data[['reportMetadata']][['primarySeriesLabel']])) {paste("**Primary Time Series:**", data[['reportMetadata']][['primarySeriesLabel']])}`
...
`r if(!isEmptyOrBlank(fetchReportMetadataField(data, 'excludeZeroNegative')) || fetchReportMetadataField(data, 'excludeMinMax')) {paste("**Advanced Options:**") }`
