...
if(!is.null(dvhplot)){
  secRefPlot <- createDVHydrographRefPlot(data, "secondaryReferenceSeries", "inputDataDescriptions2")
  terRefPlot <- createDVHydrographRefPlot(data, "tertiaryReferenceSeries", "inputDataDescriptions3")
  quaRefPlot <- createDVHydrographRefPlot(data, "quaternaryReferenceSeries", "inputDataDescriptions4")
