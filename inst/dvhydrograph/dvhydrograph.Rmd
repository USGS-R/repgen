...
if(!is.null(dvhplot)){
  secRefPlot <- createRefPlot(data, "secondaryReferenceSeries", "inputDataDescriptions2")
  terRefPlot <- createRefPlot(data, "tertiaryReferenceSeries", "inputDataDescriptions3")
  quaRefPlot <- createRefPlot(data, "quaternaryReferenceSeries", "inputDataDescriptions4")
