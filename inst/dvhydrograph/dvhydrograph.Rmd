...
`r if(!isEmptyOrBlank(data[['reportMetadata']][['downChainDescriptions1']])) {paste("**Secondary Reference Time Series:**", data[['reportMetadata']][['secondaryReferenceTimeSeries']])}`

`r if(!isEmptyOrBlank(data[['reportMetadata']][['downChainDescriptions2']])) {paste("**Tertiary Reference Time Series:**", data[['reportMetadata']][['tertiaryReferenceTimeSeries']])}`

`r if(!isEmptyOrBlank(data[['reportMetadata']][['downChainDescriptions3']])) {paste("**Quaternary Reference Time Series:**", data[['reportMetadata']][['quaternaryReferenceTimeSeries']])}`
