...
if(!identical(tbl, "The dataset requested is empty.")){
  ...
  if(any(grepl("\\s\\*$", tbl$toRet[,"Date"]))){cat("*\\* Multiple occurrences of the same extreme in selected dataset.*", "\n", seperator="\n")}
  ...
  cat("*Extremes date/time determined from un-rounded values*")
}
```
