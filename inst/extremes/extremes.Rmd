...
`r if (any(grepl("\\s\\*$", tbl[,"Date"]))){paste("*\\* Multiple occurrences of the same extreme on this date.*")}`

`r if (any(grepl("\\s\\*\\*$", tbl[,"Date"]))){paste("*\\*\\* Multiple occurrences of the same extreme in selected dataset.*")}`
