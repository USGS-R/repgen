...
if (output=='pdf') {
  pander(tbl, split.cell = 30, split.table = Inf) 
    ...
    htmlTable(tbl, cgroup=c("Field Visit Info","Peak Verification Info","Assoc Highest Inst Value and Date"),n.cgroup=c(4,6,6), col.rgroup = c("none", "#F7F7F7"), css.cell = "padding-left: .8em; padding-right: .8em; padding-top:.5em;padding-bottom:.5em;")
  }
