...
tbl <- sitevisitpeakTable(readingsData,fetchReportMetadataField(data,'excludeComments'))
library(htmlTable)
...
if(!identical(tbl, "The dataset requested is empty.")){
  tbl2 <- formatQualifiersTable(readAllFieldVisitQualifiers(parseFieldVisitReadings(data)))
